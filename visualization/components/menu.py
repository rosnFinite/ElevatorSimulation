...
EnvironmentParameterMenu = dmc.Paper(
    ...
    p="md",
    withBorder=True,
    style={"height": 400, "width": "17vw"},
    children=dmc.Group(
        grow=True,
        direction="column",
        children=[
            dmc.Text("Environment Parameter", size="lg", align="center"),
...
PassengerBehaviourMenu = dmc.Paper(
    ...
    p="md",
    withBorder=True,
    style={"height": 400, "width": "20vw"},
    children=dmc.Group(
        grow=True,
        direction="column",
        children=[
            dmc.Text("Passenger Behaviour", size="lg", align="center"),
            dmc.Divider(variant="solid", style={"marginTop": -20}),
            dmc.Space(h=10),
            dmc.RadioGroup(
