...
EXP_RATE_CHECKPOINTS = {0: [100, None, None],       # scale=100, start=random, destination=random (from 00:00)
                        2520: [1.8, 0, None],         # scale=4, start=0, destination=random        (from 7:00)
                        2880: [12, None, None],     # scale=12, start=random, destination=random  (from 8:00)
                        4320: [4, None, 0],         # scale=4, start=random, destination=0        (from 12:00)
                        4500: [8, None, None],      # scale=12, start=random, destination=random  (from 12:30)
                        4680: [4, 0, None],         # scale=4, start=0, destination=random        (from 13:00)
                        4860: [12, 0, None],        # scale=12, start=0, destination=random       (from 13:30)
